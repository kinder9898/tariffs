...
export default function TarifList() {
    const tarifs=[
        ...
        socialMediaIcons:
         ...
         hit:"http://дядя-оконщик.рф/files/special/hit-prodazh.png",period:"/месяц",internetP:40,gb:" ГБ",unlimP:"+безлимитные",callMinutes:500,callMinutesText:" мин.",unlimMinutes:"+безлимит на Tele2 России",sms:50,smsText:" SMS"},
